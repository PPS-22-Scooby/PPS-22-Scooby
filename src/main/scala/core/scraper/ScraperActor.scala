...
/**
 * A type representing a function that extract an {@link Iterable} used to build {@link Result} from a {@link Document}
 * @tparam D a type which is a subtype of {@link Document} type.
 * @tparam T a generic type which represents the expected {@link Result} type.
 */
 ...
 * @tparam D the type representing the {@link Document} to which apply the rule.
 * @tparam T type representing the {@link Result} type.
 */
...
object ScraperActor:
  ...
  /**
   * Enum representing all {@link ScraperActor} messages.
   */
  enum Messages:
   ...
   *
   * @param selectors a {@link Seq} of selectors used in scraper rule.
   ...
   * @param ids a {@link Seq} of ids used in the rule.
   ...
   *
   * @param tags a {@link Seq} of tags used in the rule.
   ...
   *
   * @param classesNames a {@link Seq} of classes used in the rule.
   ...
   *
   * @param selectors a {@link Seq} of selectors used in the rule.
   ...
   *
   * @param regex a {@link Seq} of regex used in the rule.
   ...
   *
   * @param selectors the {@link Seq} of selectors used in the first rule.
   * @param selectBy a selector to specify the rule.
   * @param regex the {@link Seq} of regex to apply in the second rule.
   * @return a rule that can be applied to {@link ScrapeDocument} to obtain an {@link Iterable} of String as a result of the concatenated rules.
   */
